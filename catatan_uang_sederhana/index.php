    ...
    <div class="wrapper">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark"> <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav"> <a class="btn btn-success me-2" href="index.php?page=tambah">+ Tambah Transaksi</a> </div>
                </div>
            </div>
        </nav>
        ...
        <div class="container">
            ...
            switch ($page) {
                case 'dashboard':
                    ?>
                    <h2 class="text-center mt-5">Selamat Datang</h2>
                ...
                case 'edit':
                    ...
                    <?php else: ?>
                        <h2 class="mb-4">Edit Transaksi <?= $transaksi_data['id'] ?></h2>
                        <form action="index.php" method="POST" enctype="multipart/form-data">
        ...
        <p>Copyright &copy; 2025 - Muhammad Refisyah</p>
    </div>
